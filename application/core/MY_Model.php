...
class MY_Model_Jamie_Rumbelow extends CI_Model {
...
class MY_Model extends MY_Model_Jamie_Rumbelow {

    protected $before_get = array('set_lc_time_names');

    protected function set_lc_time_names()
    {
        // Set lc_time_names language
        $this->db->query('set lc_time_names=nl_NL');
    }
}
